...
public class MenuTestDrive {
  public static void main(String[] args) {
    ...
    menuTestDrive.MenuTest1();
  }
  private void MenuTest2(MenuComponent menuComponent){
    System.out.println("\nComposite Iterator Test\n-----");
  ...
  private void MenuTest1(){
    ...
    pancakeHouseMenu.add(new MenuItem("K&B's Pancake Breakfast", "Pancakes wit scrambled eggs, and toast", true, 2.99));
    ...
    dinerMenu.add(new MenuItem("Streamed Veggies and Brown Rice", "Steamed vegetables over brown rice", true, 3.99));
    ...
    cafeMenu.add(new MenuItem("Veggie Burger and Air Fries", "Veggie burger on a whole wheat bum, lettuce, tomato, and fries", true, 3.99));
